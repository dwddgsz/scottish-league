...
const LatestMatchElement: React.FC<{ match: latestMatch }> = ({ match }) => {
  ...
  const { ht_score, ft_score, localteam_score, visitorteam_score } =
    match.scores;
    ...
    <LatestMatchElementWrapper>
      ...
      <div className="match__info">
        <figure className="match__team match__team">
          <figcaption
            className={localteam_score > visitorteam_score ? "winner" : ""}
          >
            {localTeam.data.name}
          </figcaption>
          <img
            className="match__logo  match__logo--home"
            src={localTeam.data.logo_path}
            alt="team-logo"
          ></img>
        </figure>
        ...
        <figure className="match__team match__team--away">
          <img
            ...
            src={visitorTeam.data.logo_path}
            alt="team-logo"
          ></img>
          <figcaption
            className={localteam_score < visitorteam_score ? "winner" : ""}
